...
import scalikejdbc.{ConnectionPool, ConnectionPoolSettings, ConnectionPoolFactory}

/**
  * Created by vsarathipagolu on 8/12/16.
  */
...
class C3P0ConnectionPool(
                          ...
                          password: String,
                          override val settings: ConnectionPoolSettings = ConnectionPoolSettings()) extends ConnectionPool(url, user, password, settings) {
